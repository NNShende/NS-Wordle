        ...
        NavigationView {
            VStack(alignment: .leading) {
                Text(
                    ...
                    After each gues, the color of the tiles will change to show how close your guess was to the word.
                    """
                )
                Divider()
                Text("**Examples**")
                VStack(alignment: .leading) {
                    ...
                    Image("Vague")
                        .resizable()
                        .scaledToFit()
                    Text("The letter **U** is not in the word at any spot.")
                }
                Divider()
                HStack(spacing: 0) {
                    Text("**Tap the** ")
                    Image(systemName: "plus.circle")
                    Text(" **button for a new WORDLE**")
                }
                Spacer()
            }
